...
In particolare, i cookie funzionali di terze parti utilizzati da **[[URL SITO]]** sono: 
...
[[URL SITO]] non utilizza il servizio *Facebook Social Plugin* per la profilazione dell'utente in prima parte e non ha accordi con *Facebook Social Plugin* per profilare in prima parte.
...
[[URL SITO]] non utilizza il servizio *Youtube* per la profilazione dell'utente in prima parte e non ha accordi con *Youtube* per profilare in prima parte.
...
**[[URL SITO]]** potrebbe contenere collegamenti ad altri siti Web che dispongono di una propria informativa sulla privacy che può essere diverse da quella adottata da **[[URL SITO]]** e quindi **non risponde** per questi siti.
