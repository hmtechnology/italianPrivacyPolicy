...
In particolare, i cookie tecnici utilizzati da **udite-udite.it** sono: 

| Nome Cookie     | Dominio         | Scadenza        | Finalità        |
| :-------------- | :-------------- | :-------------- | :-------------- |
| PHPSESSID       | udite-udite.it  | session         | Identificatore generico della sessione dell'utente, generato da applicazioni basate su linguaggio PHP, utilizzato per mantenere le variabili di sessione di un utente (ad esempio mantenere uno stato di logged-in per un utente durante la navigazione tra pagine).  |
| i18next         | udite-udite.it  | session         | Quando la lingua non è impostata esplicitamente i18next tenta di rilevare la lingua dell'utente per mostrare coerentemente il contenuto delle pagine web |
...
In particolare, i cookie analitici di terze parti utilizzati da **udite-udite.it** appartengono ai seguenti servizi: 
...
In particolare, i cookie funzionali di terze parti utilizzati da **udite-udite.it** sono: 
...
udite-udite.it non utilizza il servizio *Youtube* per la profilazione dell'utente in prima parte e non ha accordi con *Youtube* per profilare in prima parte.
 ...
 **udite-udite.it** **utilizza esclusivamente cookie di profilazione indiretta (di terze parti)**.
 ...
 In particolare, i cookie di profilazione di terze parti utilizzati da **udite-udite.it** sono: 
