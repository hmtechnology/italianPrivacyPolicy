...
Il trattamento dei dati personali viene effettuato esclusivamente per adempiere gli scopi per i quali si richiede il consenso al trattamento dei dati personali, ed in particolare, per:
...
- h) accessibili soltanto al personale autorizzato per fini legalmente autorizzati, 
- i) tutelati dalla distruzione accidentale o illecita, da perdita o alterazione accidentale e da archiviazione, trattamento, accesso o divulgazione non autorizzati o illeciti attraverso l'attuazione di idonee misure di sicurezza per prevenire la perdita dei dati, usi illeciti ed accessi non autorizzati e garantire la sicurezza dei dati nel corso del loro trattamento limitando il numero delle persone che possono avere accesso a tali dati. 
* * *
## SEZIONE VI – LA NATURA DEL CONSENSO
Nessun servizio presente all'interno del sito è obbligatorio e l'Utente è libero di scegliere di usufruire dei servizi che più preferisce.

La lettura della presente informativa e il consenso al trattamento dei dati sono obbligatori nel caso l'Utente voglia usufruire del servizi per il quale è richiesto un consenso da parte dell'Utente. Il trattamento dei dati è necessario per rispondere alle richieste ricevute e per ricontattare il mittente; il rifiuto del consenso al trattamento dei dati personali comporta una mancata erogazione del servizio per il quale il consenso viene richiesto. 
...
* * *
##SEZIONE VIII – I DIRITTI DELL'INTERESSATO
I diritti qui di seguito riportati sono previsti dall'art.7 del d.lgs.n.196/2003 
...
L'informativa è resa in tutte le lingue usate nel sito Web (italiano).
***
## SEZIONE IX – DEFINIZIONI
...
* f) "responsabile", la persona fisica, la persona giuridica, la pubblica amministrazione e qualsiasi altro ente, associazione od organismo eventualmente preposti dal titolare al trattamento di dati personali;
